...
/**
 * This class is used to create chocolates
 * 
 * @author Hugo Limón, Valeria Cortez
 * @version 0.1
 */
public class Chocolate extends ComidaMala

{
     
    /**
     *The constructor of the class Chocolate, sets the fall velocity
     *@param vel recives the fall velocity
     */
    public Chocolate(int vel){
      setImage(imagen());
      velCaida=vel;
    } 
